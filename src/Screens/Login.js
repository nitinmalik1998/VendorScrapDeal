...
const Login = () => {
  ...
  return (
    <View style={[styles.container]}>
      ...
      {/* Proceed Button */}
      <TouchableOpacity style={styles.proceedButton} onPress={() =>{navigation.navigate("Otp")}} >
        <Text style={styles.proceedText}>Send OTP</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  scrapimage1: {height: '25%', width: '100%', borderRadius: 20, marginTop: 20},
